...
public class DebugUI {
    ...
    public DebugUI(DebugVirtualMachine VM) {
        ...
        methods.put("setbkpt","setBreakPoints");
        methods.put("clrbkpt","clearBreakPoints");
        ...
        do {
            ...
            if (methodName != null) {
                try {
                    ...
                    //call the command
                    execute = (Boolean) m.invoke(this, new Object[]{command}); 
                } catch (Exception ex){
    ...
    /**
     * Set tracing on the DebugVirtualMachine to on or off.
     * @param command array of string arguments for this function.
     * @return boolean which signals if the DebugVirtualMachin should execute.
     */
